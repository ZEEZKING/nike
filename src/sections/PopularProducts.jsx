    ...
    max-sm:mt-12">
      ...
      justify-start gap-5">
        ...
        <p className="lg:max-w-lg mt-2
          ...
          and style as you explore our highly coveted selections. 
          Uncover a realm of comfort, cutting-edge design, 
      ...
      sm:gap-4  gap-14">
          {products.map((product) =>  (<PopularProductsCard 
